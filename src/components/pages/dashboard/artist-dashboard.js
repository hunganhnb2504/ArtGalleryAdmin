...
function ArtistDash() {
    ...
    useEffect(() => {
        const loadTotalOffers = async () => {
            ...
            try {
                const response = await api.get(url.DASHBOARD.TOTAL_OFFER_ARTIST);
    ...
    useEffect(() => {
        const loadTotalOfferToday = async () => {
            ...
            api.defaults.headers.common["Authorization"] = `Bearer ${userToken}`;
            try {
                const response = await api.get(url.DASHBOARD.TOTAL_OFFER_TODAY_ARTIST);
    ...
    useEffect(() => {
        const loadListOfferToday = async () => {
            ...
            api.defaults.headers.common["Authorization"] = `Bearer ${userToken}`;
            try {
                const response = await api.get(url.DASHBOARD.LIST_OFFER_TODAY_ARTIST);
    ...
    useEffect(() => {
     ...
     useEffect(() => {
        const loadTotalRevenue = async () => {
            ...
            api.defaults.headers.common["Authorization"] = `Bearer ${userToken}`;
            try {
                const response = await api.get(url.DASHBOARD.TOTAL_REVENUE_ARTIST);
    ...
    useEffect(() => {
        const loadWeeklyRevenue = async () => {
            ...
            api.defaults.headers.common["Authorization"] = `Bearer ${userToken}`;
            try {
                const response = await api.get(url.DASHBOARD.CHART_WEEKLY_ARTIST);
    ...
    useEffect(() => {
        const loadMonthlyRevenue = async () => {
            ...
            api.defaults.headers.common["Authorization"] = `Bearer ${userToken}`;
            try {
                const response = await api.get(url.DASHBOARD.CHART_MONTHLY_ARTIST.replace("{}", selectedYear));
    ...
    useEffect(() => {
        const loadYearlyRevenue = async () => {
            ...
            api.defaults.headers.common["Authorization"] = `Bearer ${userToken}`;
            try {
                const response = await api.get(url.DASHBOARD.CHART_YEARLY_ARTIST);
